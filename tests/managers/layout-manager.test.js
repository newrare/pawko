...
import { ORIENTATION, ORIENTATIONS, SAFE_ZONE } from '../../src/configs/constants.js';
...
describe('LayoutManager', () => {
  ...
  it('centers the box symmetrically inside the available area', () => {
    ...
    expect(Math.abs(leftMargin - insetLeft - (rightMargin - insetRight))).toBeLessThan(1);
    expect(Math.abs(topMargin - insetTop - (bottomMargin - insetBottom))).toBeLessThan(1);
  });
});
